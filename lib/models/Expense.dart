...
required this.date, required this.catagory}) : id = uuid.v4();
...
class ExpenseBucket{
  const ExpenseBucket({required this.catagory, required this.expense});
  ExpenseBucket.forCatagory(
    List<Expense> allExpenses, this.catagory
  )
  : expense = allExpenses
